...
OAUTH2_PROXY_SECRET=./oidc-auth/oauth2-proxy-secret.yaml
DEX_CONFIG_TEMPLATE=./oidc-auth/dex-config-template.yaml
DEX_CONFIG_SECRET=./oidc-auth/dex-config-secret.yaml
